    ...
    <div class="card">
        <div class="card-header justify-content-between">
            ...
            @if(isset($access['create']))
                <a href="{{ route('ess.permissions.create') }}" class="btn btn-primary"><i data-feather='plus'></i> Tambah Pengajuan</a>
            @endif
        </div>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                @if(isset($access['edit']) && $r->approved_status != 't')
                                    <a href="{{ route('ess.permissions.edit', $r->id) }}" class="btn btn-icon btn-primary"><i data-feather="edit"></i></a>
                                @endif
                                @if(isset($access['destroy']) && $r->approved_status != 't')
                                    <button href="{{ route('ess.permissions.destroy', $r->id) }}" id="delete" class="btn btn-icon btn-danger">
