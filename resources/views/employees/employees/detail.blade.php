    ...
    <div class="row">
        <div class="col-md-2 mb-2 mb-md-0">
            <ul class="nav nav-pills flex-column nav-left">
                ...
                @endif
                @if(isset($access['contract']))
                    <li class="nav-item">
                        <a class="nav-link" id="contract" data-toggle="pill" href="#tab-contract" aria-expanded="false">
                            <i class="fas fa-id-card"></i>
                            <span class="font-weight-bold">Kontrak</span>
                        </a>
                    </li>
                @endif
            </ul>
