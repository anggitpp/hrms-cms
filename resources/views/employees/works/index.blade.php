    ...
    <div class="card">
        <div class="card-header justify-content-between">
            ...
            @if(isset($access['create']))
                <a href="{{ route('employees.works.create') }}" class="btn btn-primary"><i data-feather='plus'></i> Tambah Riwayat Kerja</a>
            @endif
        </div>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                @if(isset($access['edit']))
                                    <a href="{{ route('employees.works.edit', $r->id) }}" class="btn btn-icon btn-primary"><i data-feather="edit"></i></a>
                                @endif
                                @if(isset($access['destroy']))
                                    <button href="{{ route('employees.works.destroy', $r->id) }}" id="delete" class="btn btn-icon btn-danger">
