...
class MonthlyReport implements FromCollection, WithHeadings, WithColumnWidths, WithStyles, WithCustomStartCell
{
    protected $filter;
    ...
    public function collection()
    {
        ...
        $sql = DB::table('attendances as t1')
            ...
            ->whereMonth('t1.date', $this->filter['filterMonth'])
            ->whereYear('t1.date', $this->filter['filterYear']);
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('A3', 'PERIODE : '.numToMonth($this->filter['filterMonth']). ' '.$this->filter['filterYear']);
